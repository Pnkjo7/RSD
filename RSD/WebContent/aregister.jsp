	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form class="login100-form validate-form flex-sb flex-w" action="Aregister" method="post">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Username is required">
						<input class="input100" type="text" name="auname" placeholder="Username">
					...
					<div class="container-login100-form-btn m-t-17">
						<button class="login100-form-btn" value="Aregister">
							Login
						</button>
					</div>
...
<!--===============================================================================================-->
	<script src="style/js/main1.js"></script>
